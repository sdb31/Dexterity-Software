...
handles.fig = figure('numbertitle','off',...
    ...
    'menubar', 'none',...
    'Position',[pos(3)/2-w/2, pos(4)/2-h/2, w, 1.1*h]);
%% Button Group 1
...
handles.Automated = uicontrol(handles.bg,'style','pushbutton',...
    'units','normalized',...
    'Position',[.05,.7,.9,.2],...
    'string','Automated Analysis',...
    'fontsize',12,'BackgroundColor',[.75 .9 .75]);
handles.Manual = uicontrol(handles.bg,'style','pushbutton',...
    'units','normalized',...
    'Position',[.05,.4,.9,.2],...
    'string','Manual Analysis',...
    'fontsize',12,'BackgroundColor',[.75 .75 .9]);
handles.Previous = uicontrol(handles.bg,'style','pushbutton',...
    'units','normalized',...
    'Position',[.05,.1,.9,.2],...
    'string','Previous Analyses',...
...
%     'Fontsize', 10, 'Fontweight', 'bold') ;
set(handles.Automated, 'callback', @Automated);
set(handles.Manual, 'callback', @Manual);
...
fig = figure('numbertitle','off','units','centimeters',...
    'name','Dexterity: Manual Analysis','menubar','none',...
